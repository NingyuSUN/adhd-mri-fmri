...
4. [09 — repeated site-and-label-stratified benchmark](https://colab.research.google.com/drive/1CkXQKR3tfbdIsuM41ML1YNPULmv9HFU2)
...
```text
<DATA_DIR>/
<DATA_DIR>/fmri/brainlm_a424/
<DATA_DIR>/fmri/strict_loso_benchmark/
<DATA_DIR>/fmri/strict_loso_benchmark/stage3_scrubbing_network/
<DATA_DIR>/fmri/benchmark_site_stratified_cv/
```
