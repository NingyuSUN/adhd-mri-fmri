...
**Current release: 378-subject fMRI, frozen 2026-09-08; packaging and evidence replay updated 2026-09-10.** This is an internal research benchmark. It is not an ADHD diagnostic service or a demonstrated externally validated predictor.

[One-page case study](CASE_STUDY.md) · [10-slide technical deck](docs/release/ADHD_fMRI_technical_deck.pptx) · [3-minute demo](docs/release/DEMO.md) · [Reproduction guide](REPRODUCIBILITY.md) · [Version index](docs/release/RESULT_VERSIONS.md)
...
- **Provenance:** [preserved original sources and hashes](src/adhd_fmri_benchmark/frozen_v1/sources.json), [aggregate verification](results/fmri_378/verification.json), [fold/repeat outputs](results/fmri_378), and explicit limits on what has been rerun.
...
python -m adhd_fmri_benchmark demo --out artifacts/synthetic-demo
```
...
```text
src/adhd_fmri_benchmark/       evidence replay, synthetic demo, portable runtime entry
...
docs/release/          short case, technical deck, demo and version notes
