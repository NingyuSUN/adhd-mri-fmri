...
Current intended use: research, teaching and hiring demonstration. Current validation: reused internal 5×3-fold cohort; no external validation, calibration or diagnostic-use claim. Latest code preserves 3 MLP seeds per fold across repeats. The newer structural v2 is outside this release.
