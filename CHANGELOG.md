...
- Replaced the internal server codename ("SV002") with generic wording in `docs/analysis_v2_deviations.md`, `docs/analysis_v2_protocol.md`, `docs/paper/FRESH_REPRODUCTION_STATUS.md`, and two source manifests (with a matching `PACKAGE_MANIFEST.json` hash/byte-count update for the one manifest that is itself hash-verified).
